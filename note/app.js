...
const replaceRegex = (regex, replacement) => function (str) {
...
const imageReplacer = (tagTitle, tagURL) => `<img src="${tagURL}" alt="${tagTitle}" />`
const linkReplacer = (tagTitle, tagURL) => `<a href="${tagURL}">${tagTitle}</a>`
